...
<nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark bg-dark">
  ...
  <form class="form-inline my-2 my-lg-7 col-md-7">
      <input class="form-control mr-sm-2 col-lg-8 col-md-8" type="" placeholder="Search for Products, Brands and more" name="">
      <input class="form-control mr-sm-1 col-lg-3 col-md-3" type="" placeholder="location" name="">
